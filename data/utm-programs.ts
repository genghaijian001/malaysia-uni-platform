...
const undergraduatePrograms: UTMProgram[] = [
  // ── Faculty of Civil Engineering (Fakulti Kejuruteraan Awam) ─────────────
  {
    ...
    intake_months: [2, 9],
    tuition_international_myr: 22180,
    tuition_international_cny_estimate: cny(22180),
    tuition_note: '首学期RM 20,542，后续学期RM 11,090/学期；年均约RM 22,180（工程类，来源：UTM SPACE IDP 2025年6月官方简章）',
    min_ielts: 5.5,
    min_toefl: 46,
    min_gpa: null,
    requirements_zh:
      '高中毕业（SPM/A-Level/STPM/UEC/高考或同等学历），数学及物理成绩优秀。中国学生需高考成绩达一本线以上，或完成受认可的预科课程（如A-Level、基础课程）。英语要求：雅思5.5（IELTS 5.5）或TOEFL iBT 46或同等成绩。',
  ...
  },
  {
    ...
    min_gpa: null,
    requirements_zh:
      '高中毕业，数学、物理及化学成绩优秀。中国学生：高考一本线以上或预科课程。英语要求：雅思5.5（IELTS 5.5）或TOEFL iBT 46或同等成绩。',
    scholarship_available: true,
  ...
  // ── Faculty of Mechanical Engineering (Fakulti Kejuruteraan Mekanikal) ───
  {
    ...
    min_gpa: null,
    requirements_zh:
      '高中毕业，数学及物理成绩优秀。中国学生：高考一本线以上，英语要求雅思5.5（IELTS 5.5）或TOEFL iBT 46或同等成绩。',
    scholarship_available: true,
    scholarship_note_zh: 'UTM International Excellence Award等。',
    curriculum_zh:
  ...
  },
  {
    ...
    min_gpa: null,
    requirements_zh:
      '高中毕业，数学及物理成绩优秀，物理成绩尤为重要。中国学生：高考一本线以上或预科课程。英语要求：雅思5.5（IELTS 5.5）或TOEFL iBT 46或同等成绩。',
    scholarship_available: true,
    scholarship_note_zh: 'UTM International Excellence Award等。',
    curriculum_zh:
  ...
  // ── Faculty of Electrical Engineering (Fakulti Kejuruteraan Elektrik) ────
  {
    ...
    min_gpa: null,
    requirements_zh:
      '高中毕业，数学及物理成绩优秀。英语要求：雅思5.5（IELTS 5.5）或TOEFL iBT 46或同等成绩。中国学生高考一本线以上。',
    scholarship_available: true,
    scholarship_note_zh: 'UTM International Excellence Award等。',
    curriculum_zh:
  ...
  },
  {
    ...
    min_gpa: null,
    requirements_zh:
      '高中毕业，数学及物理成绩优秀。英语雅思5.5（IELTS 5.5）或TOEFL iBT 46或同等成绩。中国学生高考一本线以上。',
    scholarship_available: true,
    scholarship_note_zh: 'UTM International Excellence Award等。',
    curriculum_zh:
  ...
  // ── Faculty of Chemical & Energy Engineering ─────────────────────────────
  {
    ...
    min_gpa: null,
    requirements_zh:
      '高中毕业，数学、物理及化学成绩优秀。中国学生高考一本线以上，英语雅思5.5（IELTS 5.5）或TOEFL iBT 46或同等成绩。',
    scholarship_available: true,
    scholarship_note_zh: 'UTM International Excellence Award等。',
    curriculum_zh:
  ...
  // ── Faculty of Computing (Fakulti Komputeran) ────────────────────────────
  {
    ...
    language_of_instruction: 'English',
    intake_months: [2, 9],
    tuition_international_myr: 20150,
    tuition_international_cny_estimate: cny(20150),
    tuition_note: '首学期RM 19,527，后续学期RM 10,075/学期；年均约RM 20,150（理工/计算类，来源：UTM SPACE IDP 2025年6月官方简章）',
    min_ielts: 5.5,
    min_toefl: 46,
    min_gpa: null,
    requirements_zh:
      '高中毕业，数学成绩优秀。中国学生高考一本线以上，英语雅思5.5（IELTS 5.5）或TOEFL iBT 46或同等成绩。',
    scholarship_available: true,
    scholarship_note_zh: 'UTM International Excellence Award等。',
    curriculum_zh:
  ...
  },
  {
    ...
    min_gpa: null,
    requirements_zh:
      '高中毕业，数学成绩优秀。英语雅思5.5（IELTS 5.5）或TOEFL iBT 46或同等成绩。',
    scholarship_available: true,
    scholarship_note_zh: 'UTM International Excellence Award等。',
    curriculum_zh:
  ...
  },
  {
    ...
    min_gpa: null,
    requirements_zh:
      '高中毕业，数学成绩良好。英语雅思5.5（IELTS 5.5）或TOEFL iBT 46或同等成绩。中国学生高考达到本科录取线。',
    scholarship_available: true,
    scholarship_note_zh: 'UTM International Excellence Award等。',
    curriculum_zh:
  ...
  // ── Faculty of Architecture and Built Environment ─────────────────────────
  {
    ...
    min_gpa: null,
    requirements_zh:
      '高中毕业，数学成绩优秀，具备一定美术/设计基础。英语雅思5.5（IELTS 5.5）或TOEFL iBT 46或同等成绩。中国学生高考一本线以上。',
    scholarship_available: true,
    scholarship_note_zh: 'UTM International Excellence Award等。',
    curriculum_zh:
