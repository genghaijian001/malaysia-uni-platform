...
const fsktmPrograms: UMProgram[] = [
  ...
  },
  {
    ...
    min_gpa: null,
    requirements_zh:
      '【学历要求】满足以下任一条件（来源：UM FSKTM 2025/2026博士入学要求官方文件 ARC 28.03.2025）：\n' +
      '① 研究型硕士学位（无CGPA限制）；或\n' +
      '② 临床硕士学位（无CGPA限制）；或\n' +
      '③ 课程制/混合制硕士学位（CGPA ≥ 3.00）；或\n' +
      '④ 课程制/混合制硕士学位（CGPA 2.50–2.99），且满足以下任一补充条件：\n' +
      '   (A) 1年以上相关领域工作经验；或\n' +
      '   (B) 相关领域学术发表；或\n' +
      '   (C) 奖学金获得者；或\n' +
      '   (D) UM毕业生；或\n' +
      ...
      '   (F) 通过院系（PTj）面试；或\n' +
      '   (G) 通过院系（PTj）特别评估\n' +
      '⑤ 本科学位（APEL.A认证资格）或参议院认可的其他资格\n\n' +
      '【本科学历要求（直博参考）】科学流计算机科学/信息技术荣誉学士学位（来自参议院认可大学）\n\n' +
      '【相关领域】计算机科学与信息技术领域\n\n' +
      '【Prior Publication特殊申请路线】须在相关领域有对学术知识做出贡献的已发表成果；大学教师须具备不少于3年教职经历并仍在职；申请人不得已持有任何大学的研究型博士学位。\n\n' +
      '须提交详细研究计划书（Research Proposal），需获得UM教授同意担任督导（Supervisor）方可正式申请。',
    scholarship_available: true,
    scholarship_note_zh:
