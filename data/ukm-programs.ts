...
const ftsmPrograms: UKMProgram[] = [
  ...
  },
  {
    ...
    tuition_note: '约19,000 MYR/项目总学费（课程制，1.5年），研究制另计；以学院官方公布为准',
    min_ielts: 6.5,
    min_toefl: 90,
    min_gpa: 2.75,
    requirements_zh:
      '申请人须持有计算机科学、信息技术或相关领域学士学位（CGPA≥2.75/4.00，或同等资历）；英语要求：IELTS 6.5或TOEFL iBT 90；研究制申请须提交研究计划书并联系导师；课程制须满足先修课程要求。',
    scholarship_available: true,
    scholarship_note_zh:
  ...
  },
  {
    ...
    tuition_note: '约18,000 MYR/项目总学费（课程制，1.5年）；以学院官方公布为准',
    min_ielts: 6.5,
    min_toefl: 90,
    min_gpa: 2.75,
    requirements_zh:
      '申请人须持有IT、计算机科学或相关领域学士学位（CGPA≥2.75/4.00）；英语：IELTS 6.5或TOEFL iBT 90；具备相关行业工作经验者优先。',
    scholarship_available: true,
    scholarship_note_zh:
  ...
  },
  {
    ...
    tuition_note: '约12,000 MYR/年（研究型博士，国际生），通常3-5年；以学院官方公布为准',
    min_ielts: 6.5,
    min_toefl: 90,
    min_gpa: 3.0,
    requirements_zh:
      '申请人须持有计算机科学或相关领域硕士学位（CGPA≥3.0或同等资历）；英语：IELTS 6.5或TOEFL iBT 90；须提交详细研究计划书（6-10页）并提前联系FTSM导师获得接收意向函；具备相关研究发表经历者优先。',
    scholarship_available: true,
    scholarship_note_zh:
...
const fkabPrograms: UKMProgram[] = [
  ...
  },
  {
    ...
    min_gpa: 3.0,
    requirements_zh:
      '申请人须持有工程相关领域硕士学位（CGPA≥3.0或同等资历）；英语：IELTS 6.5或TOEFL iBT 90；须提交原创研究计划书（6-10页）并提前联系导师获得接收意向函；具有已发表研究论文者优先。',
    scholarship_available: true,
    scholarship_note_zh:
...
const fepPrograms: UKMProgram[] = [
  ...
  },
  {
    ...
    min_gpa: 2.75,
    requirements_zh:
      '申请人须持有任何领域学士学位（CGPA≥2.75/4.00）；须具备至少2年全职工作经验（管理类职位优先）；英语：IELTS 6.5或TOEFL iBT 90；部分情况下工作经验丰富者可弥补学术资历不足（由学院审核）。',
    scholarship_available: true,
    scholarship_note_zh:
  ...
  },
  {
    ...
    min_gpa: 2.75,
    requirements_zh:
      '申请人须持有经济学、商科或相关领域学士学位（CGPA≥2.75/4.00）；英语：IELTS 6.5或TOEFL iBT 90；研究制申请须提交研究计划书并联系导师。',
    scholarship_available: true,
    scholarship_note_zh:
  ...
  },
  {
    ...
    tuition_note: '约10,000 MYR/年（研究型博士，国际生），通常3-5年；以学院官方公布为准',
    min_ielts: 6.5,
    min_toefl: 90,
    min_gpa: 3.0,
    requirements_zh:
      '申请人须持有经济学或相关领域硕士学位（CGPA≥3.0或同等资历）；英语：IELTS 6.5或TOEFL iBT 90；须提交详细研究计划书并提前联系FEP导师获得接收意向函；具备已发表研究论文或工作论文者优先。',
    scholarship_available: true,
    scholarship_note_zh:
...
const ppukmPrograms: UKMProgram[] = [
  ...
  },
  {
    ...
    tuition_note: '约14,000 MYR/年（研究型博士，国际生），通常3-5年；以学院官方公布为准',
    min_ielts: 6.5,
    min_toefl: 90,
    min_gpa: 3.0,
    requirements_zh:
      '申请人须持有医学、生物医学科学或相关领域硕士学位（CGPA≥3.0或同等资历）；英语：IELTS 6.5或TOEFL iBT 90；须提交详细研究计划书并提前联系PPUKM导师获得接收意向函；具备相关基础医学研究经验者优先。',
    scholarship_available: true,
    scholarship_note_zh:
...
const fstPrograms: UKMProgram[] = [
  ...
  },
  {
    ...
    min_gpa: 2.75,
    requirements_zh:
      '申请人须持有理学或相关领域学士学位（CGPA≥2.75/4.00）；英语：IELTS 6.5或TOEFL iBT 90；研究制申请须提交研究计划书并联系FST导师。',
    scholarship_available: true,
    scholarship_note_zh:
  ...
  },
  {
    ...
    tuition_note: '约11,000 MYR/年（研究型博士，国际生），通常3-5年；以学院官方公布为准',
    min_ielts: 6.5,
    min_toefl: 90,
    min_gpa: 3.0,
    requirements_zh:
      '申请人须持有理学或相关领域硕士学位（CGPA≥3.0或同等资历）；英语：IELTS 6.5或TOEFL iBT 90；须提交研究计划书并提前联系FST导师获得接收意向函；具备相关研究发表经历者优先。',
    scholarship_available: true,
    scholarship_note_zh:
