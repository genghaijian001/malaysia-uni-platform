...
const computerSciencePrograms: USMProgram[] = [
  {
    ...
    tuition_note: '每学年约MYR 14,500（国际生），以USM官网最新公布为准',
    min_ielts: 6.0,
    min_toefl: 550,
    min_gpa: null,
    requirements_zh:
  ...
  },
  {
    ...
    tuition_note: '总学费约MYR 22,000（国际生，全项目），以USM研究生院最新公布为准',
    min_ielts: 6.5,
    min_toefl: 580,
    min_gpa: 2.75,
    requirements_zh:
  ...
  },
  {
    ...
    tuition_note: '每学年约MYR 7,000（国际生研究型），以USM研究生院最新公布为准',
    min_ielts: 6.0,
    min_toefl: 550,
    min_gpa: 2.75,
    requirements_zh:
  ...
  },
  {
    ...
    tuition_note: '每学年约MYR 11,000（国际生），以USM研究生院最新公布为准',
    min_ielts: 6.5,
    min_toefl: 580,
    min_gpa: null,
    requirements_zh:
...
const engineeringPrograms: USMProgram[] = [
  {
    ...
    tuition_note: '每学年约MYR 16,000（国际生），以USM工程校区官网最新公布为准',
    min_ielts: 6.0,
    min_toefl: 550,
    min_gpa: null,
    requirements_zh:
  ...
  },
  {
    ...
    tuition_note: '每学年约MYR 16,500（国际生），以USM工程校区官网最新公布为准',
    min_ielts: 6.0,
    min_toefl: 550,
    min_gpa: null,
    requirements_zh:
  ...
  },
  {
    ...
    tuition_note: '每学年约MYR 17,500（国际生），为USM独有的航空航天工程项目；以官网最新公布为准',
    min_ielts: 6.0,
    min_toefl: 550,
    min_gpa: null,
    requirements_zh:
  ...
  },
  {
    ...
    tuition_note: '每学年约MYR 12,000（国际生），以USM研究生院最新公布为准',
    min_ielts: 6.5,
    min_toefl: 580,
    min_gpa: null,
    requirements_zh:
      '相关领域硕士学位；英语IELTS 6.5或TOEFL 580分以上；需提交详细研究计划书并获导师接收；可能须参加面试',
    scholarship_available: true,
    scholarship_note_zh:
...
const managementPrograms: USMProgram[] = [
  {
    ...
    tuition_note: '每学年约MYR 13,000（国际生），以USM管理学院官网最新公布为准',
    min_ielts: 6.0,
    min_toefl: 550,
    min_gpa: null,
    requirements_zh:
  ...
  },
  {
    ...
    language_of_instruction: 'English',
    intake_months: [3, 9],
    tuition_international_myr: 30000,
    tuition_international_cny_estimate: cny(30000),
    tuition_note: '总学费约MYR 30,000（国际生，全项目约1.5年），以USM管理学院官网最新公布为准',
    min_ielts: 6.5,
    min_toefl: 580,
    min_gpa: 2.75,
    requirements_zh:
  ...
  },
  {
    ...
    tuition_note: '每学年约MYR 7,500（国际生研究型），以USM研究生院最新公布为准',
    min_ielts: 6.0,
    min_toefl: 550,
    min_gpa: 2.75,
    requirements_zh:
      '管理、商业或相关领域学士学位（CGPA ≥ 2.75 / 4.0）；英语IELTS 6.0或TOEFL 550分以上；需提交研究计划书并联系导师',
    scholarship_available: true,
    scholarship_note_zh:
  ...
  },
  {
    ...
    min_gpa: null,
    requirements_zh:
      '相关领域硕士学位；英语IELTS 6.5或TOEFL 580分以上；详细研究计划书；导师接收函；可能须面试',
    scholarship_available: true,
    scholarship_note_zh:
...
const pharmacyPrograms: USMProgram[] = [
  {
    ...
    tuition_international_myr: 20000,
    tuition_international_cny_estimate: cny(20000),
    tuition_note: '每学年约MYR 20,000（国际生），以USM药学院官网最新公布为准',
    min_ielts: 6.5,
    min_toefl: 580,
    min_gpa: null,
    requirements_zh:
  ...
  },
  {
    ...
    tuition_international_myr: 13000,
    tuition_international_cny_estimate: cny(13000),
    tuition_note: '每学年约MYR 13,000（国际生），以USM研究生院最新公布为准',
    min_ielts: 6.5,
    min_toefl: 580,
    min_gpa: null,
    requirements_zh:
      '药学或生物医学相关硕士学位；英语IELTS 6.5或TOEFL 580分以上；详细研究计划书；导师接收函',
    scholarship_available: true,
    scholarship_note_zh:
...
const medicalPrograms: USMProgram[] = [
  {
    ...
    tuition_note: '每学年约MYR 37,000（国际生），以USM医学院官网最新公布为准；总学费约MYR 185,000（5年）',
    min_ielts: 7.0,
    min_toefl: 600,
    min_gpa: null,
    requirements_zh:
  ...
  },
  {
    ...
    tuition_note: '每学年约MYR 25,000（国际生），专科医生培训项目；以USM医学院官网最新公布为准',
    min_ielts: 7.0,
    min_toefl: 600,
    min_gpa: null,
    requirements_zh:
  ...
  },
  {
    ...
    tuition_international_myr: 14000,
    tuition_international_cny_estimate: cny(14000),
    tuition_note: '每学年约MYR 14,000（国际生），以USM研究生院最新公布为准',
    min_ielts: 6.5,
    min_toefl: 580,
    min_gpa: null,
    requirements_zh:
      '生物医学科学、医学或相关领域硕士学位；英语IELTS 6.5或TOEFL 580分以上；详细研究计划书；须获导师接收；医学背景（MBBS）者可直接申请',
    scholarship_available: true,
    scholarship_note_zh:
...
const sciencePrograms: USMProgram[] = [
  {
    ...
    tuition_international_myr: 14000,
    tuition_international_cny_estimate: cny(14000),
    tuition_note: '每学年约MYR 14,000（国际生），以USM理学院官网最新公布为准',
    min_ielts: 6.0,
    min_toefl: 550,
    min_gpa: null,
    requirements_zh:
  ...
  },
  {
    ...
    tuition_note: '每学年约MYR 13,500（国际生），以USM理学院官网最新公布为准',
    min_ielts: 6.0,
    min_toefl: 550,
    min_gpa: null,
    requirements_zh:
