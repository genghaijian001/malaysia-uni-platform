...
const upmPrograms: UPMProgram[] = [
...

  {
    ...
    tuition_note: '每学年约MYR 14,000（国际生），以UPM官方公布费用为准',
    min_ielts: 6.0,
    min_toefl: 80,
    min_gpa: null,
    requirements_zh:
...

  {
    ...
    tuition_note: '每学年约MYR 13,500（国际生），以UPM官方公布费用为准',
    min_ielts: 6.0,
    min_toefl: 80,
    min_gpa: null,
    requirements_zh:
...

  {
    ...
    tuition_note: '每学年约MYR 15,500（国际生），以UPM官方公布费用为准',
    min_ielts: 6.0,
    min_toefl: 80,
    min_gpa: null,
    requirements_zh:
...

  {
    ...
    tuition_international_myr: 16000,
    tuition_international_cny_estimate: cny(16000),
    tuition_note: '每学年约MYR 16,000（国际生），以UPM官方公布费用为准',
    min_ielts: 6.0,
    min_toefl: 80,
    min_gpa: null,
    requirements_zh:
...

  {
    ...
    tuition_note: '每学年约MYR 16,500（国际生），以UPM官方公布费用为准',
    min_ielts: 6.0,
    min_toefl: 80,
    min_gpa: null,
    requirements_zh:
...

  {
    ...
    tuition_note: '每学年约MYR 13,000（国际生），以UPM官方公布费用为准',
    min_ielts: 6.0,
    min_toefl: 80,
    min_gpa: null,
    requirements_zh:
...

  {
    ...
    tuition_note: '每学年约MYR 28,000–33,000（国际生），以UPM官方公布费用为准；第四至五年临床实习年费用可能有所不同',
    min_ielts: 6.5,
    min_toefl: 90,
    min_gpa: null,
    requirements_zh:
...

  {
    ...
    tuition_international_myr: 13000,
    tuition_international_cny_estimate: cny(13000),
    tuition_note: '每学年约MYR 12,000–14,000（国际生），以UPM官方公布费用为准',
    min_ielts: 6.0,
    min_toefl: 80,
    min_gpa: null,
    requirements_zh:
...

  {
    ...
    tuition_note: '每学年约MYR 12,000–13,500（国际生），以UPM官方公布费用为准',
    min_ielts: 6.0,
    min_toefl: 80,
    min_gpa: null,
    requirements_zh:
